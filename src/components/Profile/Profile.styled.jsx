...
font-weight:${p => p.username ? p.theme.fontWeights.bold : p.theme.fontWeights.normal};
...
color:${p => typeof p.children === 'number' ? p.theme.colors.black : p.theme.colors.text};
font-weight:${p => typeof p.children === 'number'? p.theme.fontWeights.bold : p.theme.fontWeights.normal};
`;